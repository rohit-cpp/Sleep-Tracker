  ...
  return (
    <div className='bg-gray-100 p-6 '>
      <div className='bg-white shadow-lg rounded-lg p-8 mx-auto'>
        <h3 className='text-5xl font-bold text-center mb-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent border-b border-gray-200 pb-6'>
          Sleep History
        </h3>
