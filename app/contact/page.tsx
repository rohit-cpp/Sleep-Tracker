      ...
      <section className='py-16 px-8 bg-white'>
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            const mailtoLink = `mailto:rrgawanderohit@gmail.com?subject=Message from ${name}&body=Email: ${email}%0D%0A%0D%0A${message}`;
      ...
      <section className='py-16 px-8 bg-gray-100'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
          <div>
            ...
            <p className='text-gray-600'>supporthelp@sleeptracker.com</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className='text-gray-600'>
              123 SleepTracker, Dream City, India
            </p>
          </div>
        </div>
      </section>
